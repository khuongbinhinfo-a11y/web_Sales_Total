...
const env = {
  ...
  resendEnabled: toBool(process.env.RESEND_ENABLED, false),
  resendApiKey: String(process.env.RESEND_API_KEY || "").trim(),
  emailReplyTo: String(process.env.EMAIL_REPLY_TO || "").trim(),
  emailFromDefault: String(process.env.EMAIL_FROM_DEFAULT || "").trim(),
  emailFromSecurity: String(process.env.EMAIL_FROM_SECURITY || "").trim(),
  emailFromSupport: String(process.env.EMAIL_FROM_SUPPORT || "").trim(),
  emailFromQuotes: String(process.env.EMAIL_FROM_QUOTES || "").trim(),
  emailFromCareers: String(process.env.EMAIL_FROM_CAREERS || "").trim(),
