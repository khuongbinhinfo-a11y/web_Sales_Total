    ...
    await client.query(
      `INSERT INTO products(id, app_id, name, cycle, price, currency, credits, active)
       VALUES
         ...
         ('cap01_beta_year_299', 'hoctap-cap-01', 'Học Hứng Khởi Tiểu Học - Desktop Offline - Gói ra mắt', 'yearly', 299000, 'VND', 0, TRUE),
    ...
    await client.query(
      `INSERT INTO product_keys(id, product_id, key_value, status)
       VALUES
         ...
         (gen_random_uuid(), 'cap01_beta_year_299', 'HHK-BETA299-0001', 'available'),
         (gen_random_uuid(), 'cap01_beta_year_299', 'HHK-BETA299-0002', 'available'),
