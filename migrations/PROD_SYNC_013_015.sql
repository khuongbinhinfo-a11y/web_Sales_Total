...
-- Đồng bộ 100% từ local canonical version (including test products)
-- Applied: 2026-04-22
...
-- Sync study products (including test products for QA)
...
-- Add demo-map product (Google Map Customer Data Scraper)
INSERT INTO products(id, app_id, name, cycle, price, currency, credits, active)
VALUES
...
-- Add demo license keys for testing
...
-- Verification: Show synced products
-- SELECT id, app_id, name, price, active FROM products WHERE app_id IN ('app-study-12', 'lamviec') ORDER BY app_id, id;
